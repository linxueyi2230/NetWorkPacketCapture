...
import com.ecent.capture.Constants;
import com.ecent.capture.entity.PackageShowInfo;
import com.ecent.capture.R;
import com.ecent.capture.fragment.BaseFragment;
import com.ecent.capture.fragment.CaptureFragment;
import com.ecent.capture.fragment.HistoryFragment;
import com.ecent.capture.fragment.SettingFragment;
import com.ecent.vpn.ProxyConfig;
import com.ecent.vpn.utils.VpnServiceHelper;

import java.util.ArrayList;

import static com.ecent.vpn.VPNConstants.*;
import static com.ecent.vpn.utils.VpnServiceHelper.START_VPN_SERVICE_REQUEST_CODE;
...
public class VPNCaptureActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initTab();
        //推荐用户进行留评
        boolean hasFullUseApp = sharedPreferences.getBoolean(Constants.HAS_FULL_USE_APP, false);
        if (hasFullUseApp) {
            boolean hasShowRecommand = sharedPreferences.getBoolean(Constants.HAS_SHOW_RECOMMAND, false);
            if (!hasShowRecommand) {
                sharedPreferences.edit().putBoolean(Constants.HAS_SHOW_RECOMMAND, true).apply();
                showRecommand();
            } else {
