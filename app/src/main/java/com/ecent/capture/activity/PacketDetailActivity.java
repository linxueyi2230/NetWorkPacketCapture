...
import com.ecent.vpn.utils.SaveDataFileParser;
...
public class PacketDetailActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sp = getSharedPreferences(Constants.DATA_SAVE, MODE_PRIVATE);
        sp.edit().putBoolean(Constants.HAS_FULL_USE_APP, true).apply();
        refreshView();
    }
